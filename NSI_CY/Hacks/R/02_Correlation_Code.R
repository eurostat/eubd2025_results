...
pdeaths_dt_all <- readRDS(paste0(mapr_path,"PremDeaths_PM25.rds"))        # Eurostat - Premature Deaths from Eurostat (at YEARLY and NUTS0 Level)
copern_nuts3 <- readRDS(paste0(corln_path,"NDDI_DDays_PMg5_YEARLY.rds"))  # Copernicus - CAMS ReAnlysis YEARLY data for 2013-2022
...
pdf(paste0(corrln_reslts, "01_Scatter_PMg5.pdf"))
...
pdf(paste0(corrln_reslts, "02_Correlation_PMg5.pdf"))
